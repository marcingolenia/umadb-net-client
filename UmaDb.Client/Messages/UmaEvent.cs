...
/// <param name="Metadata">Optional key-value entries (e.g. correlation id, source). Stored and returned as an ordered list, not deduplicated — the store allows duplicate keys.</param>
